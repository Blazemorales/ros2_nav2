...
// IWYU pragma: private, include "urg_node_msgs/msg/status.h"


#ifndef URG_NODE_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
#define URG_NODE_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
...
#include "urg_node_msgs/msg/rosidl_generator_c__visibility_control.h"
 ...
 * calls
 * urg_node_msgs__msg__Status__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_urg_node_msgs
urg_node_msgs__msg__Status *
urg_node_msgs__msg__Status__create(void);

/// Destroy msg/Status message.
/**
 * It calls
 * urg_node_msgs__msg__Status__fini()
 ...
 * urg_node_msgs__msg__Status__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * urg_node_msgs__msg__Status__Sequence__fini()
 * on the array,
...
#endif  // URG_NODE_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
